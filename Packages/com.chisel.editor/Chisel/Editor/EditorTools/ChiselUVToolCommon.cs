...
namespace Chisel.Editors
{
    ...
    sealed class ChiselUVToolCommon : ScriptableObject
    {
        ...
        static Vector3 SnapIntersection(Vector3 intersectionPoint, SurfaceReference surfaceReference, out bool haveWeSnapped)
        {
            ...
            // TODO: only snap on vertices on selected surfaces / use intersection loops of new algorithm, to snap to subtracted pieces
        ...
        internal static void RenderVertexBox()
        {
            RenderVertexBox(ChiselUVToolCommon.worldIntersection);
        }
